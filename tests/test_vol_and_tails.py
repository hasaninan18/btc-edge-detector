...
def test_block_bootstrap_ci_brackets_the_point_estimate():
    ...
    lo, hi = block_bootstrap_variant_delta(outcomes, pv, pb, windows,
                                         n_boot=400, seed=1)
    assert lo < point < hi
...
def test_block_bootstrap_is_wider_than_naive_resampling():
    ...
    blo, bhi = block_bootstrap_variant_delta(outcomes, pv, pb, windows,
                                           n_boot=600, seed=2)
    nlo, nhi = block_bootstrap_variant_delta(outcomes, pv, pb, singles,
                                           n_boot=600, seed=2)
...
def test_block_bootstrap_is_reproducible_under_a_fixed_seed():
    ...
    a = block_bootstrap_variant_delta(outcomes, pv, pb, windows, n_boot=200, seed=99)
    b = block_bootstrap_variant_delta(outcomes, pv, pb, windows, n_boot=200, seed=99)
    assert a == b
